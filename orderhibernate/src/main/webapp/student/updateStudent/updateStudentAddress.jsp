...
<table width="750" align="center" border="1">
	...
	<tr height="120">
		<td>名字<td><%=s.getStudentName() %><td>
	<tr height="120">
		<td>生日<td><%=s.getStudentBirth() %><td>
	<tr height="120">
		<td>地址<td><%=s.getAddress() %>
		<td><form method="post" action="../../updateStudentController">
			<input type="text" required="required" style="padding: 25px; font-size: 15px;" name="studentAddress" value=""><input type="submit"></form>
	<tr height="120">
